...
TOKEN = "7572205133:AAGDTWpvCcszPg5HKHbDXtjjlPpeWK71IKc"
...
def send_price(message):
    ...
    bot.send_message(message.chat.id, f'Цена {crypto_name} в USDT {price}')

def get_price_by_ticker(*, ticker) -> float:
